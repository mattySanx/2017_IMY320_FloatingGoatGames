...
function initModel() {
	...
	if(american) {
		loader.load('american/characterfixednormals.json', function(geometry, materials) {
			var material1 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('american/apparel.png'), side: THREE.DoubleSide});
			var material2 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('american/head.png'), side: THREE.DoubleSide});
	...
	if(russian) {
		loader.load('russian/russianRIGIFIFUCKUP.json', function(geometry, materials) {
			var material1 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('russian/coat.png'), side: THREE.DoubleSide});
			var material2 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('russian/gloves.001.png'), side: THREE.DoubleSide});
			var material3 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('russian/apparel.png'), side: THREE.DoubleSide});
			var material4 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('russian/pants.png'), side: THREE.DoubleSide});
			var material5 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('russian/face.png'), side: THREE.DoubleSide});
			var material6 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('russian/hat.png'), side: THREE.DoubleSide});
	...
	if(cuban) {
		loader.load('cuban/cuban3.json', function(geometry, materials) {
			...
			var material3 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('cuban/PANTS.png'), side: THREE.DoubleSide});
			var material4 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('cuban/BELT.png'), side: THREE.DoubleSide});
			var material5 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('cuban/SHIRT.png'), side: THREE.DoubleSide});
			var material6 = new THREE.MeshPhongMaterial({map: new THREE.TextureLoader().load('cuban/cubanHead.001.png'), side: THREE.DoubleSide});
